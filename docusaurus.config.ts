...
const config: Config = {
  title: 'HvH Guide',
  tagline: "Sorry Kid. You Got The Gift, But It Looks Like You're Waiting For Something",
    ...
    [
      'classic',
      {
        docs: {
          ...
          rehypePlugins: [[rehypeExtendedTable, { colspanWithEmpty: true }]],
          editUrl: 'https://github.com/hvh-guide/hvh-guide/tree/main',
        },
        blog: {
